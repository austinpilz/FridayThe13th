        ...
        if (arena.getGameManager().isGameEmpty()) {
            if (arena.getGameManager().getPlayerManager().getNumberOfPlayers() == 0) {
                ...
                if (arena.getLocationManager().getNumberStartingPoints() >= 8) {
                    sign.setLine(2, arena.getGameManager().getPlayerManager().getNumberOfPlayers() + " / 9");
                } else {
                    sign.setLine(2, arena.getGameManager().getPlayerManager().getNumberOfPlayers() + " / " + (arena.getLocationManager().getNumberStartingPoints() + 1));
                }
            }
