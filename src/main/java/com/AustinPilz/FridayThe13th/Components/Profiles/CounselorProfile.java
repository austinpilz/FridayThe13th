...
public enum CounselorProfile {
    ...
    CounselorProfile(String name, String internal, String sn, F13Skin sk, F13Level level, int order, CounselorTraitLevel c, CounselorTraitLevel l, CounselorTraitLevel i, CounselorTraitLevel sp, CounselorTraitLevel sta, CounselorTraitLevel ste, CounselorTraitLevel str, F13SoundEffect gasp) {
        counselorName = name;
