...
public enum CounselorTraitLevel {
    ...
    Stamina_1("Stamina", 1, 0, 0.2, 0.60),
    Stamina_2("Stamina", 2, 0, 0.19, 0.65),
    Stamina_3("Stamina", 3, 0, 0.18, 0.6),
    Stamina_4("Stamina", 4, 0, 0.17, 0.7),
    Stamina_5("Stamina", 5, 0, 0.16, 0.75),
    Stamina_6("Stamina", 6, 0, 0.15, 0.8),
    Stamina_7("Stamina", 7, 0, 0.14, 0.85),
    Stamina_8("Stamina", 8, 0, 0.13, 0.09),
    Stamina_9("Stamina", 9, 0, 0.12, 0.095),
    Stamina_10("Stamina", 10, 0, 0.1, 0.1),
