...
public class Shop_CounselorPerksMenu {
    public static void openMenu(Player player) {
        ...
        Inventory inventory = Bukkit.createInventory(null, size, ChatColor.DARK_GREEN + FridayThe13th.language.get(Bukkit.getConsoleSender(), "game.title.CounselorPerksShopMenu", "Counselor Perks") + ChatColor.WHITE + " [CP: " + f13Player.getFormattedCP() + "]");
