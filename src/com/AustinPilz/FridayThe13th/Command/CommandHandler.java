            ...
            if (args[0].equalsIgnoreCase("setup")) {
                        ...
                        if (args.length == 2) {
                            ...
                            if (!FridayThe13th.arenaController.doesArenaExist(arenaName)) {
                                ...
                                try {
                                    ...
                                    sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.arenaSetupSessionInProgress", "You already have an arena setup session in progress. You must finish that session before starting a new one."));
                                }
                            } else {
                                //An arena with that name already exists in the arena controller memory
                                sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.arenaAlreadyExists", "Arena {0}{1}{2} already exists. Please choose another name and try again.", ChatColor.RED, arenaName, ChatColor.WHITE));
                            }
                        } else {
                            //Incorrect setup syntax
                            sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.setupSyntaxError", "Incorrect setup syntax. Usage: {0}", ChatColor.AQUA + "/f13 setup [arenaName]"));
                        }
                    } else {
                        //The command was sent by something other than an in-game player
                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.consoleSender", "This command must be executed by an in-game player, not the console."));
                    }
                } else {
                    //No permissions
                    sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.noPermission", "You don't have permission to access this command."));
                }
                        ...
                        if (args.length == 2) {
                            ...
                            if (FridayThe13th.arenaController.doesArenaExist(arenaName)) {
                                ...
                                try {
                                    ...
                                    sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.message.arenaDeleted", "Arena {0} has been deleted successfully.", ChatColor.RED + arenaName + ChatColor.WHITE));
                                ...
                                //An arena with that name already exists in the arena controller memory
                                sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.arenaDoesNotExist", "Arena {0} does not exist.", ChatColor.RED + arenaName + ChatColor.WHITE));
                            }
                        } else {
                            //Incorrect setup syntax
                            sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.deleteSyntaxError", "Incorrect delete syntax. Usage: {0}", ChatColor.AQUA + "/f13 delete [arenaName]"));
                        }
                    } else {
                        //The command was sent by something other than an in-game player
                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.consoleSender", "This command must be executed by an in-game player, not the console."));
                        ...
                        if (args.length == 3) {
                            ...
                            if (args[2].equalsIgnoreCase("spawn")) {
                                ...
                                try {
                                    ...
                                    //They already have a setup session in progress
                                    sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.addArenaSessionExisting", "You already have an arena setup session in progress. You must finish that session before starting a new one."));
                                } catch (ArenaDoesNotExistException exception) {
                                ...
                                if (args[2].equalsIgnoreCase("chest:weapon")) {
                                    try {
                                        ...
                                        //They already have a setup session in progress
                                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.addChestWeaponSessionExisting", "You already have a weapon chest setup session in progress. You must finish that session before starting a new one."));
                                    } catch (ArenaDoesNotExistException exception) {
                                        //An arena with that name does not exist in the arena controller memory
                                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.arenaDoesNotExist", "Arena {0} does not exist.", ChatColor.RED + arenaName + ChatColor.WHITE));
                                    }
                                    ...
                                    try {
                                        ...
                                        //They already have a setup session in progress
                                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.addChestItemSessionExisting", "You already have an item chest setup session in progress. You must finish that session before starting a new one."));
                                    } catch (ArenaDoesNotExistException exception) {
                                        //An arena with that name does not exist in the arena controller memory
                                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.arenaDoesNotExist", "Arena {0} does not exist.", ChatColor.RED + arenaName + ChatColor.WHITE));
                                    }
                                    ...
                                    sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.chestTypeError", "Unknown chest type. Available types are {0} and {1}.", ChatColor.AQUA + "chest:weapon" + ChatColor.WHITE, ChatColor.AQUA + "chest:item" + ChatColor.WHITE));
                                }
                            } else {
                                //Unknown add command
                                sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.addItemError", "Incorrect add item. Available items are {0} and {1}.", ChatColor.AQUA + "spawn" + ChatColor.WHITE, ChatColor.AQUA + "chest" + ChatColor.WHITE));
                            }
                        } else {
                            //Incorrect setup syntax
                            sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.addSyntaxError", "Incorrect add syntax. Usage: {0}", ChatColor.AQUA + "/f13 delete [arenaName] [object]"));
                        }
                    } else {
                        //The command was sent by something other than an in-game player
                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.consoleSender", "This command must be executed by an in-game player, not the console."));
                    ...
                    if (sender instanceof Player) {
                        ...
                        if (args.length == 2) {
                            ...
                            try {
                                ...
                                sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.arenaGameFull", "The game in {0} is currently full.", ChatColor.RED + arenaName + ChatColor.WHITE));
                            } catch (GameInProgressException exception) {
                                sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.arenaGameInProgress", "The game in {0} is already in progress. You'll need to wait until it's over to join.", ChatColor.RED + arenaName + ChatColor.WHITE));
                            }
                        } else {
                            //Incorrect play syntax
                            sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.playSyntaxError", "Incorrect play syntax. Usage: {0}", ChatColor.AQUA + "/f13 play [arenaName]"));
                        }
                    } else {
                        //The command was sent by something other than an in-game player
                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.consoleSender", "This command must be executed by an in-game player, not the console."));
                ...
                if (sender.hasPermission("FridayThe13th.Admin") || sender.hasPermission("FridayThe13th.*")) {
                    if (args.length == 2) {
                        ...
                        //Incorrect setup syntax
                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.arenaSyntaxError", "Incorrect arena syntax. Usage: {0}", ChatColor.AQUA + "/f13 arena [arenaName]"));
                    }
                } else {
                    //No permissions
                    sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.noPermission", "You don't have permission to access this command."));
                ...
                if (sender.hasPermission("FridayThe13th.Admin") || sender.hasPermission("FridayThe13th.*")) {
                    if (sender instanceof Player) {
                        if (FridayThe13th.arenaCreationManager.doesUserHaveActiveSession(((Player) sender).getUniqueId().toString())) {
                            ...
                            sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.noSetupSession", "You currently have no setup session in progress."));
                        }
                    } else {
                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.consoleSender", "This command must be executed by an in-game player, not the console."));
                    }
                ...
                if (sender.hasPermission("FridayThe13th.User")) {
                    ...
                    if (sender instanceof Player) {
                        try {
                            ...
                            sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.senderNotPlaying", "You are not currently playing."));
                        }
                    } else {
                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.consoleSender", "This command must be executed by an in-game player, not the console."));
                    }
                ...
                if (sender.hasPermission("FridayThe13th.Admin") || sender.hasPermission("FridayThe13th.*")) {
                    if (FridayThe13th.arenaController.getNumberOfArenas() > 0) {
                        ...
                        //There are no arenas
                        sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.noArenasToDisplay", "There are no arenas to display."));
                    }
                } else {
                    sender.sendMessage(FridayThe13th.pluginAdminPrefix + FridayThe13th.language.get(Bukkit.getConsoleSender(), "command.error.noPermission", "You don't have permission to access this command."));
                }
